...
Slint ships with many applications out of the box to write and read and convert documents in various formats, communicate by email, text and audio chat, play audio and video, send and receive documents peer to peer, edit audio, video and graphical documents, develop applications. It is fully usable as a server on a console and using one of the several included desktops.
...
Slint need translators! If you want to participate to the translation effort, read the instructions in https://slint.fr/doc/Translators.html[Translators]. Everybody is free to contribute, but please first make sure you meet the requirements listed in this document
...
If you choose the Auto installation mode and dedicate a device for Slint, the installer will partition it for you. When done you can still tune the partitions' layout using one of the aforementioned commands mosted below if yiu whish.
