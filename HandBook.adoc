...
If you choose the Auto installation mode and dedicate a device for Slint, the installer will partition it for you. When done you can still tune the partitions' layout using one of the aforementioned commands listed below if you wish.
...
The commands cfdisk, fdisk, gdisk, cgfdisk and parted are available in the installer. You can use them to partition the whole device or make the partitions for Slint in its freed space.
